...
public class TracksProviderUtilsImpl implements TracksProviderUtils {
  ...
  public Location createTrackPoint(Cursor cursor) {
    Location location = new TracksLocation("");
  ...
  private ContentValues createContentValues(Location location, long trackId) {
    ...
    if (location instanceof TracksLocation) {
      TracksLocation myTracksLocation = (TracksLocation) location;
  ...
  private void fillTrackPoint(Cursor cursor, CachedTrackPointsIndexes indexes, Location location) {
    ...
    if (location instanceof TracksLocation && !cursor.isNull(indexes.sensorIndex)) {
      TracksLocation myTracksLocation = (TracksLocation) location;
