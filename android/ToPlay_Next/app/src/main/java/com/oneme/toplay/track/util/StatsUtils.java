...
public class StatsUtils {
  ...
  public static void setLocationValues(
    ...
    // Set elevation
    boolean showGradeElevation = true;// PreferencesUtils.getBoolean(
    ...
    // Set coordinate
    boolean showCoordinate = false;//PreferencesUtils.getBoolean(
  ...
  public static void setTripStatisticsValues(Context context, Activity activity, View view,
    ...
    // Set grade/elevation
    boolean showGradeElevation = true;//PreferencesUtils.getBoolean(context,
