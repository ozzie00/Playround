...
package com.oneme.toplay.track.io.file.importer;
...
abstract class AbstractFileTrackImporter extends DefaultHandler implements TrackImporter {
  ...
  private final TracksProviderUtils myTracksProviderUtils;
  ...
  AbstractFileTrackImporter(
      Context context, long importTrackId, TracksProviderUtils myTracksProviderUtils) {
