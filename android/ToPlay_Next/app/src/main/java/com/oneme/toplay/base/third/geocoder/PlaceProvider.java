...
public class PlaceProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.oneme.toplay.base.third.geocoder.PlaceProvider";
    ...
    String mKey = AppConstant.OMETOPLAYGOOGLEPLACEKEY;//  "key=YOUR_BROWSER_KEY";
    ...
    private String getPlaceDetailsUrl(String ref){
       ...
       // String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=500&types=food&name=cruise&key=AIzaSyAWF807dWOPwod6y9-GIlnQgeARbA2BKug&";

        String url = "https://maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&key=AIzaSyAWF807dWOPwod6y9-GIlnQgeARbA2BKug";
