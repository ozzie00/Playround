...
public class MapNextActivity extends BaseActivity  implements LocationListener,
    GooglePlayServicesClient.ConnectionCallbacks,
    GooglePlayServicesClient.OnConnectionFailedListener{

    private static final String TAG = "MapNextActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationClient = new LocationClient(MapNextActivity.this, MapNextActivity.this, MapNextActivity.this);
        ...
        postsQueryAdapter = new ParseQueryAdapter<Invite>(MapNextActivity.this, factory) {
            @Override
    ...
    private boolean servicesConnected() {
        ...
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(MapNextActivity.this);
        ...
        if (ConnectionResult.SUCCESS == resultCode) {
            ...
            Dialog dialog = GooglePlayServicesUtil.getErrorDialog(resultCode, MapNextActivity.this, 0);
            if (dialog != null) {
    ...
    private void startPeriodicUpdates() {
        locationClient.requestLocationUpdates(locationRequest, MapNextActivity.this);
    }
    ...
    private void stopPeriodicUpdates() {
        locationClient.removeLocationUpdates(MapNextActivity.this);
    }
       ...
       // menu.findItem(R.id.action_setting).
        settingItem.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(MapNextActivity.this, SettingActivity.class));
                return true;
            }
        });
        ...
        if (ParseUser.getCurrentUser() != null){
            ...
            loginItem.setOnMenuItemClickListener(new OnMenuItemClickListener() {
                public boolean onMenuItemClick(MenuItem item) {
                    startActivity(new Intent(MapNextActivity.this, LoginActivity.class));
                    return true;
                }
            });
        }
