...
import com.oneme.toplay.track.fragments.ChartFragment;
...
import com.oneme.toplay.track.util.FileUtils;
 ...
 */
public class TrackDetailNextActivity extends BaseActivity
        ...
        public void run() {
          ...
          if (hasPhoto && photoUri != null) {
            ...
            long id = TrackRecordingServiceConnectionUtils.addMarker(
                TrackDetailNextActivity.this, trackRecordingServiceConnection, waypointCreationRequest);

            if (id != -1L) {
              FileUtils.updateMediaScanner(TrackDetailNextActivity.this, photoUri);
            }
          }
        }
      });
      ...
      sharedPreferenceChangeListener = new OnSharedPreferenceChangeListener() {
        ...
        public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
          ...
          if (key == null || key.equals(
              PreferencesUtils.getKey(TrackDetailNextActivity.this, R.string.recording_track_id_key))) {
            recordingTrackId = PreferencesUtils.getLong(
                TrackDetailNextActivity.this, R.string.recording_track_id_key);
          }
          if (key == null || key.equals(PreferencesUtils.getKey(
              TrackDetailNextActivity.this, R.string.recording_track_paused_key))) {
            recordingTrackPaused = PreferencesUtils.getBoolean(TrackDetailNextActivity.this,
                R.string.recording_track_paused_key,
                PreferencesUtils.RECORDING_TRACK_PAUSED_DEFAULT);
          }
          if (key == null || key.equals(
              PreferencesUtils.getKey(TrackDetailNextActivity.this, R.string.sensor_type_key))) {
            sensorType = PreferencesUtils.getString(TrackDetailNextActivity.this,
          ...
          if (key != null) {
            runOnUiThread(new Runnable() {
                @Override
              public void run() {
                ApiAdapterFactory.getApiAdapter().invalidMenu(TrackDetailNextActivity.this);
  ...
  private final OnClickListener stopListener = new OnClickListener() {
    ...
    public void onClick(View v) {
      ...
      TrackRecordingServiceConnectionUtils.stopRecording(
          TrackDetailNextActivity.this, trackRecordingServiceConnection, true);
    }
  };
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    if (CheckGoogleService.access(TrackDetailNextActivity.this)) {
    ...
    TabSpec statsTabSpec = tabHost.newTabSpec(StatsNextFragment.STATS_FRAGMENT_TAG).setIndicator(
        getString(R.string.track_detail_stats_tab),
        getResources().getDrawable(R.drawable.ic_tab_stats));
    tabsAdapter.addTab(statsTabSpec, StatsNextFragment.class, null);
  ...
  protected void onStart() {
    ...
    //android.util.Log.d(" toplay ", "TrackDetailActity onStart() ");
 ...
 // }
  ...
  protected void onHomeSelected() {
     ...
     */
    TaskStackBuilder.create(this).addParentStack(TrackDetailNextActivity.class).startActivities();
    finish();
  }
