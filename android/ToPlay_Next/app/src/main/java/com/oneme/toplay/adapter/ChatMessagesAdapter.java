...
public class ChatMessagesAdapter {// extends ResourceCursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        holder.friendAvator      = (ImageView) view.findViewById(R.id.friend_avator);
        holder.message           = (TextView) view.findViewById(R.id.message_text);
        holder.time              = (TextView) view.findViewById(R.id.message_text_time);
     ...
     //   holder.time              = (TextView) view.findViewById(R.id.message_text_date);
      ...
      //  holder.received          = (ImageView) view.findViewById(R.id.chat_row_received);
        ...
        holder.friendAvator.setVisibility(View.GONE);
       ...
       // holder.received.setVisibility(View.GONE);
        ...
        switch(type) {
            ...
            case Constants.MESSAGE_TYPE_FRIEND:
                ...
                holder.friendAvator.setVisibility(View.VISIBLE);
                holder.message.setText(msg.message);
                holder.message.setVisibility(View.VISIBLE);
                holder.time.setText(PrettyTimestamp.prettyTimestamp(msg.time, true));
                holder.time.setVisibility(View.VISIBLE);
            ...
            case Constants.MESSAGE_TYPE_FILE_TRANSFER_FRIEND:
                mSingleton.fileSizeMap.put(id,size);
                ...
                if (msg.received) {
                    ...
                    holder.progressText.setText(context.getResources().getString(R.string.OMEPARSECHATFILETRANMITFINISH));// "Finished");
                    ...
                    if (msg.sent) {
                        if (msg.message_id != -1) {
                            ...
                            holder.progress.setProgress(mSingleton.getProgress(msg.id));
                            Tuple<Integer, Long> progress = mSingleton.getProgressSinceXAgo(msg.id, 5000);
                            int bytesPerSecond;
                            if (progress != null) {
                            ...
                            holder.progressText.setText(context.getResources().getString(R.string.OMEPARSECHATFILETRANMITFAILED));
                            holder.progressText.setVisibility(View.VISIBLE);
                        }
                    } else {
                        if (msg.message_id != -1) {
                            if (msg.isMine()) {
                                holder.progressText.setText(context.getResources().getString(R.string.OMEPARSECHATFILETRANMITREQUEST));
                            } else {
                                ...
                                holder.accept.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        mSingleton.acceptFile(k, message_id, context);
                                    }
                                });
                                holder.reject.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        mSingleton.rejectFile(k, message_id, context);
                                    }
                                });
                            }
                        } else { //Filesending request not accepted, we no longer have a filenumber, but it hasn't been accepted
                            holder.progressText.setText(context.getResources().getString(R.string.OMEPARSECHATFILETRANMITREJECT));//"Rejected");
                        }
                        holder.progressText.setVisibility(View.VISIBLE);
                    }
                }
                                        ...
                                        case 1: //Delete
                                            class DeleteMessage extends AsyncTask<Void, Void, Void> {
                                                ...
                                                protected Void doInBackground(Void... params) {
                                                    Database mDatabase = new Database(context.getApplicationContext());
                                                    mDatabase.deleteMessage(id);
                                                    mDatabase.close();
                                                    return null;
                                                }
                                                ...
                                                protected void onPostExecute(Void result) {
                                                    mSingleton.updateMessages(context);
                                                }
    ...
    private void ownMessage(ChatMessagesHolder holder) {
        ...
        holder.message.setTextColor(context.getResources().getColor(R.color.grey_darkest));
