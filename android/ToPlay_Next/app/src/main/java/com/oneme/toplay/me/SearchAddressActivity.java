...
public class SearchAddressActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ome_activity_search_address);
        ...
        final Boolean isAvailable = CheckGoogleService.access(SearchAddressActivity.this);
        ...
        final EditText searchedittext = (EditText) findViewById(R.id.uploadvenue_search_content_text_view);
        ...
        ImageView mlogo = (ImageView)findViewById(R.id.uploadvenue_search_google_logo);
        if (isAvailable) {
            mlogo.setVisibility(View.VISIBLE);
        }

        // setting search list view
        msearchresult = (ListView) findViewById(R.id.uploadvenue_search_location_list);
        msearchresult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                newIntent.putExtra(Application.INTENT_EXTRA_SEARCHADDRESS, mselectlocation.mName);
    ...
    class getBdPlaceAutocomplete extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... key) {
            ...
            try {
                ...
                newText          = newText.replace(AppConstant.OMEPARSEPLUSSTRING, AppConstant.OMEPARSESPACESTRING);
            ...
            runOnUiThread(new Runnable(){
                public void run(){
                    madapter = new resultListAdapter(SearchAddressActivity.this, msuggest);
    ...
    class getPlaceAutocomplete extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... key) {
            ...
            try {
                ...
                LocationData muserinput = new LocationData();
                muserinput.mName     = getResources().getString(R.string.OMEPARSEINVITESEARCHLOCATIONCUSTOM);
                msuggest.add(muserinput);
    ...
    class resultListAdapter extends ArrayAdapter<LocationData> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.ome_activity_search_address_item, null);
                convertView.setLayoutParams(new AbsListView.LayoutParams(LayoutParams.FILL_PARENT,
                        LayoutParams.WRAP_CONTENT));
                // Creates a ViewHolder and store references to the two children views
                // we want to bind data to.
                holder         = new ViewHolder();
                holder.address = (TextView) convertView.findViewById(R.id.search_address_view);
           ...
           // mlocation = mPostingData.get(position);
            ...
            if (mlocation.mName!=null){
                  holder.address.setText(mlocation.mName);
            }
    ...
    class getBdNearbyPlace extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... key) {
            ...
            try {
                ...
                mbdstringBuilder.append(AppConstant.BD_PLACE_QUERY + AppConstant.BD_PLACE_SEARCH_ADDRESS);
