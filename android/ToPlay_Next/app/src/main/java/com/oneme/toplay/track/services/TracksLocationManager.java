 ...
 * @author Jimmy Shih
 */
public class TracksLocationManager {
  ...
  public TracksLocationManager(Context context, Looper looper, boolean enableLocaitonClient) {
  ...
  /**
   * Closes the {@link TracksLocationManager}.
   */
  public void close() {
