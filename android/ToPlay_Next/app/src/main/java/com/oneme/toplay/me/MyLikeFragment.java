...
public class MyLikeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        msearchresult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final FollowingPlayer mfollower      = madapter.getItem(position);
                String mmemberusername               = mfollower.getFollowerUsername();
        ...
        mfollowernumber = (TextView)rootView.findViewById(R.id.myprofile_count_number);
        mfollowertext   = (TextView)rootView.findViewById(R.id.myprofile_count_text);
        ...
        protected String doInBackground(String... key) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    followingquery.setLimit(MAX_FOLLOWER_SEARCH_RESULTS);
                    followingquery.findInBackground(new FindCallback<FollowingPlayer>() {
                        public void done(List<FollowingPlayer> followingList, ParseException e) {
                            if (e == null) {
                                mfollowernumber.setText(Integer.toString(followingList.size()));
                                mfollowertext.setText(getResources().getString(R.string.OMEPARSEFOLLOWERLOWERCASE));
                                for (FollowingPlayer following : followingList) {
                                    ...
                                    if (msuggest.size() < MAX_FOLLOWER_SEARCH_RESULTS) {
    ...
    class resultListAdapter extends ArrayAdapter<FollowingPlayer> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            mfollower                     = getItem(position);
            final ParseUser mfollowerUser = mfollower.getFollowerUser();
            String mfollowerUsename       = mfollowerUser.getUsername();

            if (mfollowerUser != null) {
                LoadImageFromParseCloud.getAvatar(getActivity(), mfollowerUser, holder.avatar);
            }
