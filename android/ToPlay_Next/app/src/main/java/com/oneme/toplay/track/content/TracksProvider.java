...
public class TracksProvider extends ContentProvider {
  ...
  public TracksProvider() {
    ...
    uriMatcher.addURI(TracksProviderUtils.AUTHORITY, TrackPointsColumns.TABLE_NAME,
        UrlType.TRACKPOINTS.ordinal());
    uriMatcher.addURI(TracksProviderUtils.AUTHORITY, TrackPointsColumns.TABLE_NAME + "/#",
        UrlType.TRACKPOINTS_ID.ordinal());
    uriMatcher.addURI(
        TracksProviderUtils.AUTHORITY, TracksColumns.TABLE_NAME, UrlType.TRACKS.ordinal());
    uriMatcher.addURI(TracksProviderUtils.AUTHORITY, TracksColumns.TABLE_NAME + "/#",
        UrlType.TRACKS_ID.ordinal());
    uriMatcher.addURI(
        TracksProviderUtils.AUTHORITY, WaypointsColumns.TABLE_NAME, UrlType.WAYPOINTS.ordinal());
    uriMatcher.addURI(TracksProviderUtils.AUTHORITY, WaypointsColumns.TABLE_NAME + "/#",
  ...
  public int delete(Uri url, String where, String[] selectionArgs) {
   ...
   // Log.w(TracksProvider.TAG, "Deleting table " + table);
    int count;
    try {
      db.beginTransaction();
