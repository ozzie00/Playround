...
static CGFloat const kOMEActivityViewActivityIndicatorPadding = 10.f;

#import "OMEActivityView.h"

@implementation OMEActivityView
...
- (void)layoutSubviews {
	...
	self.activityIndicator.center = CGPointMake(self.label.frame.origin.x - (self.activityIndicator.frame.size.width / 2) - kOMEActivityViewActivityIndicatorPadding, self.label.frame.origin.y + (self.label.frame.size.height / 2));
}
